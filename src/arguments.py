...
class ModelArguments:
    ...
    pooling_method: str = field(default='weightedmean', metadata={
                                "help": "Pooling method for sentences"})
    normalized: bool = field(default=True)
    attn_implementation: str = field(default='sdpa', metadata={
                                     "help": "eager/sdpa/flash_attention_2"})
    attn: str = field(
        default='bbcc',
        metadata={
    ...
    projection: int = field(default=None, metadata={
                            "help": "Optional linear learned embedding down projection"})
...
class DataArguments:
    ...
    use_unique_indices: bool = field(
        default=False,
        metadata={
            "help": "If unified with different emb & gen dataset lens, ensure samples are unique in each epoch"}
    )
    prefixlm: bool = field(default=False, metadata={
                           "help": "PrefixLM for generative"})
...
class CustomTrainingArguments(TrainingArguments):
    ...
    loss_gen_factor: float = field(
        default=1.0, metadata={"help": "Factor to scale generative loss by"})
    loss_gen_type: str = field(default="mixed", metadata={
        "help": "Type of gen loss: mixed/token"})
    lora: bool = field(default=False, metadata={"help": "Use LoRA PEFT"})
    qlora: bool = field(default=False, metadata={"help": "Use QLoRA PEFT"})
    save_safetensors: bool = field(default=False, metadata={
        "help": "Save in safetensors format"})
    split_emb: bool = field(default=False, metadata={
        "help": "Split embedding forward / backward pass"})
    split_emb_full: bool = field(default=False, metadata={
        "help": "Split embedding forward / backward pass"})
    emb_q_only: bool = field(default=False, metadata={
        "help": "Only backprop on q's"})
    emb_p_only: bool = field(default=False, metadata={
        "help": "Only backprop on p's (pos & neg)"})
